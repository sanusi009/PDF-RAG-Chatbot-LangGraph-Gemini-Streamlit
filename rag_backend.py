...
def chat_node(state: ChatState, config=None):
    ...
    system_message = SystemMessage(
        content=(
            ...
            f"the 'rag_tool' tool with the query and thread_id='{thread_id}' — this is the "
            "current conversation's thread_id, always pass it exactly as given. Use the "
            "calculator tool when helpful. If no document is available for this thread, "
